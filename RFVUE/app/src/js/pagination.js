! function (a, b) {
    ...
    function e(a) {
        ...
        b.each(c, function (b, c) {
            a.off(h + c)
        }), a.data("jspagination", {}), b(".paginationjs", a).remove()
    }
    ...
    var g = "jspagination",
        h = "__pagination-";
    b.fn.jspagination && (g = "pagination2"), b.fn[g] = function (f) {
        ...
        var j = b(this),
            ...
            l = {
                initialize: function () {
                    var a = this;
                    if (j.data("jspagination") || j.data("jspagination", {}), !1 !== a.callHook("beforeInit")) {
                        j.data("jspagination").initialized && b(".paginationjs", j).remove(), a.disabled = !!k.disabled;
                        var c = a.model = {
                        ...
                        a.parseDataSource(k.dataSource, function (b) {
                            if (a.isAsync = i.isString(b), i.isArray(b) && (c.totalNumber = k.totalNumber = b.length), a.isDynamicTotalNumber = a.isAsync && k.totalNumberLocator, !(k.hideWhenLessThanOnePage && a.getTotalPage() <= 1)) {
                                var d = a.render(!0);
                                k.className && d.addClass(k.className), c.el = d, j["bottom" === k.position ? "append" : "prepend"](d), a.observer(), j.data("jspagination").initialized = !0, a.callHook("afterInit", d)
                            }
                        })
                    }
                },
                ...
                go: function (a, c) {
                    function d(a) {
                        ...
                        if (f.direction = void 0 === f.pageNumber ? 0 : g > f.pageNumber ? 1 : -1, f.pageNumber = g, e.render(), e.disabled && e.isAsync && e.enable(), j.data("jspagination").model = f, k.formatResult) {
                            var d = b.extend(!0, [], a);
                            i.isArray(a = k.formatResult(d)) || (a = d)
                        }
                        j.data("jspagination").currentPageData = a, e.doCallback(a, c), e.callHook("afterPaging", g), 1 == g && e.callHook("afterIsFirstPage"), g == e.getTotalPage() && e.callHook("afterIsLastPage")
                    }
                    var e = this,
                        f = e.model;
                    if (!e.disabled) {
        ...
        if (j.data("jspagination") && !0 === j.data("jspagination").initialized) {
            ...
            if ("string" == typeof f) {
                ...
                switch (m[0] = h + m[0], f) {
                    ...
                    case "getSelectedPageNum":
                        return j.data("jspagination").model ? j.data("jspagination").model.pageNumber : j.data("jspagination").attributes.pageNumber;
                    case "getTotalPage":
                        return Math.ceil(j.data("jspagination").model.totalNumber / j.data("jspagination").model.pageSize);
                    case "getSelectedPageData":
                        return j.data("jspagination").currentPageData;
                    case "isDisabled":
                        return !0 === j.data("jspagination").model.disabled;
                    default:
                        c("Unknown action: " + f)
                }
                return this
        ...
        var e = b(this),
            f = e.data("jspagination");
        f || (e.data("jspagination", {}), f = e.data("jspagination")), !f.hooks && (f.hooks = {}), f.hooks[a] = f.hooks[a] || [], f.hooks[a].push(d)
    }, b[g] = function (a, d) {
